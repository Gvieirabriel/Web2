                        ...
                        <table class="table">
                            ...
                            <tr>
                              ...
                              <th>Data</th>
                                ...
                                <tbody>
                                    <c:forEach items="${atendimentos}" var="atendimento" varStatus="count">
                                            <tr>
                                            <td><c:out value = "${clientes[count.index]}"/></td>
                                            <td><c:out value = "${produtos[count.index]}"/></td>
                                            <fmt:formatDate value="${atendimento.dtHrAtendimento}"pattern="dd/MM/YYYY hh:mm" var="formateDate"/>
                                            <td><c:out value = "${formateDate}"/></td>
                                            <td><a href="AtendimentoServlet?action=show&id=" onclick="location.href=this.href+${atendimento.idAtendimento};return false;"><i class="glyphicon glyphicon-list-alt"></i></a></td>
                                            </tr>
                                    </c:forEach>
                                </tbody>
                        </table>
